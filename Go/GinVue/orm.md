...
> **Noted** ignored fields won’t be created when using GORM Migrator to create table
...
And you can use tag `embeddedPrefix` to add prefix to embedded fields’ db name
